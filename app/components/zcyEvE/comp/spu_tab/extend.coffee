commentListTemplate = Handlebars.templates["zcyEvE/comp/spu_tab/templates/user-description"]
supplier = Handlebars.templates["zcyEvE/comp/spu_tab/templates/supplier"]
dealRecordTpl = Handlebars.templates["zcyEvE/comp/spu_tab/templates/dealrecord-list"]
...
class Tab
  constructor: ($) ->
    ...
    if !goodsId or !itemId or !supplierCode
      return
    @$tab = @$el
