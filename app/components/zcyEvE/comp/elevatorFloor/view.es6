const productListTemplate = Handlebars.templates["zcyEvE/elevatorFloor/templates/productList"]
const brandListTemplate = Handlebars.templates["zcyEvE/elevatorFloor/templates/brandList"]
