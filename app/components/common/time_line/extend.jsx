class TimeLine {
  ...
  constructor(_selector,_config){
    var config = $.extend(TimeLine.config, _config);
    ...
    /* 更多按钮 */
    if (trList.length > 10) {
      var moreHtml = "<div class=\"mb-lg\"><a href=\"javascript:;\" onclick=\"$(this).parents('.sr-timeline').find('tr').show();$(this).parent().remove()\">展开更多流转日志</a><i class=\"icon-zcy icon-xiangxiazhedie ml\" style=\"font-size: 10px;color: #999;\"></i></div>";
